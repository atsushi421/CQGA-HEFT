## read data file
d1 <- read.table("../result/change_InoutRatio/QLHEFT/InoutRatio_1.5.txt")
d1 <- d1$V2
d1_nume <- as.numeric(d1)
d1_median <- median(d1_nume)
d1 <- d1 / d1_median  # QLHEFT_1.5_median
d2 <- read.table("../result/change_InoutRatio/QLHEFT/InoutRatio_3.0.txt")
d2 <- d2$V2
d2_nume <- as.numeric(d2)
d2_median <- median(d2_nume)
d2 <- d2 / d2_median  # QLHEFT_3_median
d3 <- read.table("../result/change_InoutRatio/QLHEFT/InoutRatio_6.0.txt")
d3 <- d3$V2
d3_nume <- as.numeric(d3)
d3_median <- median(d3_nume)
d3 <- d3 / d3_median  # QLHEFT_6_median
d4 <- read.table("../result/change_InoutRatio/QLHEFT/InoutRatio_12.0.txt")
d4 <- d4$V2
d4_nume <- as.numeric(d4)
d4_median <- median(d4_nume)
d4 <- d4 / d4_median  # QLHEFT_12_median
d5 <- read.table("../result/change_InoutRatio/QLHEFT/InoutRatio_24.0.txt")
d5 <- d5$V2
...
## read data file
d1 <- read.table("../result/change_InoutRatio/Proposed/InoutRatio_1.5.txt")
d1 <- d1$V2
d1 <- d1 / d1_median  # QLHEFT_1.5_median
d2 <- read.table("../result/change_InoutRatio/Proposed/InoutRatio_3.0.txt")
d2 <- d2$V2
d2 <- d2 / d2_median  # QLHEFT_3_median
d3 <- read.table("../result/change_InoutRatio/Proposed/InoutRatio_6.0.txt")
d3 <- d3$V2
d3 <- d3 / d3_median  # QLHEFT_6_median
d4 <- read.table("../result/change_InoutRatio/Proposed/InoutRatio_12.0.txt")
d4 <- d4$V2
d4 <- d4 / d4_median  # QLHEFT_12_median
d5 <- read.table("../result/change_InoutRatio/Proposed/InoutRatio_24.0.txt")
d5 <- d5$V2
d5 <- d5 / d5_median  # QLHEFT_24_median
proposed <- cbind(d1, d2, d3, d4, d5) # bind data

## read data file
d1 <- read.table("../result/change_InoutRatio/HEFT/InoutRatio_1.5.txt")
d1 <- d1$V2
d1 <- d1 / d1_median  # QLHEFT_1.5_median
d2 <- read.table("../result/change_InoutRatio/HEFT/InoutRatio_3.0.txt")
d2 <- d2$V2
d2 <- d2 / d2_median  # QLHEFT_3_median
d3 <- read.table("../result/change_InoutRatio/HEFT/InoutRatio_6.0.txt")
d3 <- d3$V2
d3 <- d3 / d3_median  # QLHEFT_6_median
d4 <- read.table("../result/change_InoutRatio/HEFT/InoutRatio_12.0.txt")
d4 <- d4$V2
d4 <- d4 / d4_median  # QLHEFT_12_median
d5 <- read.table("../result/change_InoutRatio/HEFT/InoutRatio_24.0.txt")
d5 <- d5$V2
d5 <- d5 / d5_median  # QLHEFT_24_median
...
comparison_BoxPlot <- function(all_data) {
    ...
    plot(
        0, 0, type = "n",
        xlab = "Ratio", ylab = "Makespan", # labels
...
## output file as eps
postscript("change_InoutRatio_normalization_qlheft_BoxPlot.eps", horizontal = F, onefile = FALSE, paper = "special", width = 8, height = 6)
comparison_BoxPlot(all_data)
dev.off()

## output file as png
png("change_InoutRatio_normalization_qlheft_BoxPlot.png", width = 600, height =400)
comparison_BoxPlot(all_data)
dev.off()